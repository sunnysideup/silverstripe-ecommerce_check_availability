...
class OrderStatusLog_CheckAvailability extends OrderStatusLog
{
    ...
    **/
    ...
    public function AvailabilityCheckedNice()
    {
        return $this->getAvailabilityCheckedNice();
    }
    public function getAvailabilityCheckedNice()
    {
    ...
    {
        return _t("OrderStatusLog.AVAILABILITYCHECK", "Availability Check");
    }

    public static $plural_name = "Availability Checks";
    public function i18n_plural_name()
    {
        return _t("OrderStatusLog.AVAILABILITYCHECKS", "Availability Checks");
    }
